...
var VirtualizedList = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function VirtualizedList(_props) {
    ...
    _this._defaultRenderScrollComponent = function (props) {
      ...
      var inversionStyle = _this.props.inverted ? _this.props.horizontal ? styles.rowReverse : styles.columnReverse : null;
      ...
      if (_this._isNestedWithSameOrientation()) {
        ...
        return (
          ...
          React.createElement(_ScrollView.default, _extends({}, props, {
            ...
            contentContainerStyle: _StyleSheet.default.compose(inversionStyle, _this.props.contentContainerStyle)
          }))
        );
      } else {
        // $FlowFixMe Invalid prop usage
        return /*#__PURE__*/React.createElement(_ScrollView.default, _extends({}, props, {
          contentContainerStyle: _StyleSheet.default.compose(inversionStyle, _this.props.contentContainerStyle)
        }));
      }
    };
        ...
        if (!isVirtualizationDisabled) {
          ...
          if (visibleLength > 0 && contentLength > 0) {
            ...
            if (!_this.props.initialScrollIndex || _this._scrollMetrics.offset) {
              newState = (0, _VirtualizeUtils.computeWindowedRenderLimits)(_this.props, state, _this._getFrameMetricsApprox, _this._scrollMetrics); // revert the state if calculations are off
    ...
    if (_this.props.viewabilityConfigCallbackPairs) {
      ...
      _this.pushOrUnshift(_this._viewabilityTuples, {
  ...
  _proto._pushCells = function _pushCells(cells, stickyHeaderIndices, stickyIndicesFromProps, first, last, inversionStyle) {
    ...
    var _loop = function _loop(ii) {
      ...
      if (stickyIndicesFromProps.has(ii + stickyOffset)) {
        _this2.pushOrUnshift(stickyHeaderIndices, cells.length);
      }

      _this2.pushOrUnshift(cells, /*#__PURE__*/React.createElement(CellRenderer, {
