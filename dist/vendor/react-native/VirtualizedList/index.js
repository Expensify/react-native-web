      ...
      if (_this._isNestedWithSameOrientation()) {
        ...
        return (
          ...
          React.createElement(ScrollView, _extends({}, props, {
            ...
            contentContainerStyle: StyleSheet.compose(inversionStyle, _this.props.contentContainerStyle)
          }))
        );
      } else {
        // $FlowFixMe Invalid prop usage
        ...
        if (!isVirtualizationDisabled) {
          ...
          if (visibleLength > 0 && contentLength > 0) {
            ...
            if (!_this.props.initialScrollIndex || _this._scrollMetrics.offset) {
              newState = computeWindowedRenderLimits(_this.props, state, _this._getFrameMetricsApprox, _this._scrollMetrics); // revert the state if calculations are off
